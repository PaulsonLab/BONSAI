...
Created on Mon Feb 19 14:44:29 2024
 This script contains the BOFN code and logEI code from the sources cited in our paper
 As already mentioned in the other scripts, these are single level problems ignore the uncertain variables
The outer optimization problem has been wrap the below single level optimization problems using these considerations 
