...
Contains the GP posterior and acquisition function for the network based techniques described in the paper
@author: kudva.7
"""
...
class GaussianProcessNetwork(Model):
    """
    This class is the exact copy (not exactly exact...) of 
