...
if __name__ == '__main__':
    ...
    w_set = [[0,0.2,0.4,0.6,1.],[0.0000, 0.100, 0.1250, 0.2000, 0.2500, 0.300, 0.3750, 0.4500, 0.5000, 0.5700, 0.6250, 0.700, 0.7500, 0.8750, 0.9500, 1.0000]]
    w_set_1 = [i*0.5 for i in w_set[0]]
    w_set_2 = [i*2*3.14 for i in w_set[1]]
    ...
    if visualize_robust:
        for i in range(N**2):
            ...
            yy = wc_vals[...,1] + wc_vals[...,2] + wc_vals[...,0]
    ...
    #plt.scatter(xy_best[0], xy_best[1], marker = '*', color = 'black', s = 300, label = 'Nominal Solution')
    ...
    plt.savefig('polynomial_robust.svg', format='svg', bbox_inches='tight')
